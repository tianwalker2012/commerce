...
$plid=$result[0]['plid'];
$lastint=$plid % 10;
$sql="select pmid,plid,authorid author ,message,dateline,pmtype  from pre_ucenter_pm_messages_$lastint where plid=$plid  order by dateline desc limit $start,$limit ";
$result=DB::fetch_all($sql);

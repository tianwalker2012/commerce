...
0
|| checktplrefresh('data/diy/./template/default//group/index.htm', './template/default/common/header.htm', 1363829755, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy/./template/default/', 'group/index')
|| checktplrefresh('data/diy/./template/default//group/index.htm', './template/default/common/footer.htm', 1363829755, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy/./template/default/', 'group/index')
|| checktplrefresh('data/diy/./template/default//group/index.htm', './template/default/common/header_common.htm', 1363829755, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy/./template/default/', 'group/index')
|| checktplrefresh('data/diy/./template/default//group/index.htm', './template/default/common/pubsearchform.htm', 1363829755, 'diy', './data/template/1_diy_group_index.tpl.php', 'data/diy/./template/default/', 'group/index')
;
block_get('1,2');?>
...
<!--[diy=diy5]--><div id="diy5" class="area"><div id="frameGhevps" class="frame move-span cl frame-1-1"><div id="frameGhevps_left" class="column frame-1-1-l"><div id="frameGhevps_left_temp" class="move-span temp"></div><?php block_display('1');?></div><div id="frameGhevps_center" class="column frame-1-1-r"><div id="frameGhevps_center_temp" class="move-span temp"></div><?php block_display('2');?></div></div></div><!--[/diy]-->
</div>

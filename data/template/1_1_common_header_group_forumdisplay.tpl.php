...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1363829997, '1', './data/template/1_1_common_header_group_forumdisplay.tpl.php', './template/default', 'common/header_group_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1363829997, '1', './data/template/1_1_common_header_group_forumdisplay.tpl.php', './template/default', 'common/header_group_forumdisplay')
;?>

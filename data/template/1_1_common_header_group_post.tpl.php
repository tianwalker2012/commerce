...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1363831355, '1', './data/template/1_1_common_header_group_post.tpl.php', './template/default', 'common/header_group_post')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1363831355, '1', './data/template/1_1_common_header_group_post.tpl.php', './template/default', 'common/header_group_post')
;?>

<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('spacecp_ec_rate');
0
|| checktplrefresh('./template/default/home/spacecp_ec_rate.htm', './template/default/common/header.htm', 1364284267, '1', './data/template/1_1_home_spacecp_ec_rate.tpl.php', './template/default', 'home/spacecp_ec_rate')
|| checktplrefresh('./template/default/home/spacecp_ec_rate.htm', './template/default/common/footer.htm', 1364284267, '1', './data/template/1_1_home_spacecp_ec_rate.tpl.php', './template/default', 'home/spacecp_ec_rate')
|| checktplrefresh('./template/default/home/spacecp_ec_rate.htm', './template/default/common/header_common.htm', 1364284267, '1', './data/template/1_1_home_spacecp_ec_rate.tpl.php', './template/default', 'home/spacecp_ec_rate')
|| checktplrefresh('./template/default/home/spacecp_ec_rate.htm', './template/default/common/pubsearchform.htm', 1364284267, '1', './data/template/1_1_home_spacecp_ec_rate.tpl.php', './template/default', 'home/spacecp_ec_rate')
;?>
...
<div class="z"><a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em> 信用评价</div>
</div>
<div id="ct" class="wp cl">
<div class="mn">
<h1 class="mt">3.信用评价</h1>
<form method="post" autocomplete="off" action="home.php?mod=spacecp&amp;ac=eccredit&amp;op=rate" id="postform">
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<input type="hidden" name="referer" value="<?php echo dreferer(); ?>" />
<div class="bm">
<h3 class="bm_h">发表评价</h3>
<div class="bm_c">
<table cellspacing="0" cellpadding="0" class="tfm">
<tr>
<th>被评价人</span></th>
<td>
<?php if($_G['uid'] == $order['buyerid']) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $order['sellerid'];?>" target="_blank"><?php echo $order['seller'];?></a>
<?php } else { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $order['buyerid'];?>" target="_blank"><?php echo $order['buyer'];?></a>
<?php } ?>
</td>
</tr>
<tr>
<th>相关商品</th>
<td><a href="forum.php?mod=redirect&amp;goto=findpost&amp;pid=<?php echo $order['pid'];?>" target="_blank"><?php echo $order['subject'];?></a></td>
</tr>
<tr>
<th>进度</th>
<td>
<label for="rate_good" class="lb"><input id="rate_good" name="score" value="1" type="radio" class="pr" checked="checked" /><span style="color:red"><img src="<?php echo STATICURL;?>image/traderank/good.gif" border="0" width="14" height="16" /> <strong>好评</strong><?php if(!$order['offline']) { ?>(加1分)<?php } ?></span></label>
<label for="rate_soso" class="lb"><input id="rate_soso" name="score" value="0" type="radio" class="pr" /><span style="color:green"><img src="<?php echo STATICURL;?>image/traderank/soso.gif" border="0" width="14" height="16" /> <strong>中评</strong><?php if(!$order['offline']) { ?>(不加分)<?php } ?></span></label>
<label for="rate_bad" class="lb"><input id="rate_bad" name="score" value="-1" type="radio" class="pr" /><img src="<?php echo STATICURL;?>image/traderank/bad.gif" border="0" width="14" height="16" /> <strong>差评</strong><?php if(!$order['offline']) { ?>(扣1分)<?php } ?></label>
</td>
</tr>
<tr>
<th valign="top">评价</th>
...
<button type="submit" class="pn pnc" id="postsubmit" name="ratesubmit" value="true"><strong>提交</strong></button>
</td>
</tr>
</table>
</div>

...
<a href="<?php echo $tradeattach['url'];?>/<?php echo $tradeattach['attachment'];?>" target="_blank"><img class="spimg" src="<?php echo $tradeattach['url'];?>/<?php if($tradeattach['thumb']) { ?><?php echo getimgthumbname($tradeattach['attachment']);?><?php } else { ?><?php echo $tradeattach['attachment'];?><?php } ?>" alt="" /></a>
<?php } ?>
</div>
</dd>
<?php } ?>

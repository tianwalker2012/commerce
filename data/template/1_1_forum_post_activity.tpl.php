...
<?php if($activityattach['attachment']) { ?>
<a href="<?php echo $activityattach['url'];?>/<?php echo $activityattach['attachment'];?>" target="_blank"><img class="spimg" src="<?php echo $activityattach['url'];?>/<?php if($activityattach['thumb']) { ?><?php echo getimgthumbname($activityattach['attachment']);?><?php } else { ?><?php echo $activityattach['attachment'];?><?php } ?>" alt="" /></a>
<?php } ?>
</div>
</dd>
<?php } ?>

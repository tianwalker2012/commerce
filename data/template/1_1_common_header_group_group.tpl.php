...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1363829876, '1', './data/template/1_1_common_header_group_group.tpl.php', './template/default', 'common/header_group_group')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1363829876, '1', './data/template/1_1_common_header_group_group.tpl.php', './template/default', 'common/header_group_group')
;?>

...
<table cellspacing="0" cellpadding="5">
<tr>
<td width="15"><input type="checkbox" name="operations[]" class="pc" value="bump" <?php echo $defaultcheck['bump'];?> /></td>
...
var imgk = new Array();<?php if(is_array($imgattach)) foreach($imgattach as $imginfo) { ?><?php $a = '\"\'\t\\""\\\''."\\\\";$k = getforumimg($imginfo['aid'], 1, 120, 80);?>imgk[<?php echo $imginfo['aid'];?>] = '<?php echo $k;?>';
<?php } ?>

...
0
|| checktplrefresh('./template/default/home/spacecp_friend.htm', './template/default/home/space_friend_nav.htm', 1363608546, '1', './data/template/1_1_home_spacecp_friend.tpl.php', './template/default', 'home/spacecp_friend')
...
<?php if($i%2==1) { ?></tr><tr><?php } ?><?php $i++;?><?php } ?>
</tr></table>
</div>
<p class="o pns">
...
<p class="mtn xg1">(附言为可选，<?php echo $tospace['username'];?> 会看到这条附言，最多50个字符 )</p>
<p class="mtm">

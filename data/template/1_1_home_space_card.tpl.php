<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_card');?><?php include template('common/header'); ?><?php $encodeusername = rawurlencode($space['username']);?><?php if(!empty($_G['setting']['pluginhooks']['space_card_top'])) echo $_G['setting']['pluginhooks']['space_card_top'];?>
<div class="card_mn">
<div class="avt">
...
<div<?php if($allowupdatedoing) { ?><?php $scdoingid='scdoing'.random(4);?> id="return_<?php echo $scdoingid;?>" onclick="cardUpdatedoing('<?php echo $scdoingid;?>', 0)"<?php } ?>><?php echo $space['spacenote'];?><?php if(helper_access::check_module('doing') && $allowupdatedoing) { ?> <a href="javascript:;" class="xi2">[更新记录]</a><?php } ?></div>

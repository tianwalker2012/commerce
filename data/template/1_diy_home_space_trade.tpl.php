...
0
|| checktplrefresh('./template/default/home/space_trade.htm', './template/default/home/space_thread_nav.htm', 1364212602, 'diy', './data/template/1_diy_home_space_trade.tpl.php', './template/default', 'home/space_trade')
;?><?php include template('common/header'); ?><?php $_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;do=trade\">商品</a>";?><?php if($_GET['view'] == 'eccredit') { ?><?php $_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=$do&amp;view=eccredit\">TA 的信用评价</a>";?><?php } else { ?><?php $_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=$do&amp;view=onlyuser\">TA 的所有商品</a>";?><?php } ?>
...
<span class="y">
<?php if($_GET['view']=='me') { ?><?php $actives[onlyuser]=' class="a"';?><?php } if($space['uid'] > 0) { ?>
...
<?php } if($_GET['view'] == 'tradelog') { ?><?php $selltrades = array('all' => '全部交易', 'trading' => '进行中的', 'attention' => '关注的', 'eccredit' => '评价过的', 'success' => '成功的', 'refund' => '退款的', 'closed' => '失败的', 'unstart' => '未生效的');?><div class="tl tlog">

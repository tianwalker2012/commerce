...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1363775997, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1363775997, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1363775997, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1363775997, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1363775997, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
;?>
...
<?php if(!empty($_G['setting']['pluginhooks']['forum_bottom'])) echo $_G['setting']['pluginhooks']['forum_bottom'];?><?php $focusid = getfocus_rand($_G[basescript]);?><?php if($focusid !== null) { ?><?php $focus = $_G['cache']['focus']['data'][$focusid];?><div class="focus" id="focus">
<div class="bm">
<div class="bm_h cl">
...
<em>&copy; 2001-2012 <a href="http://www.comsenz.com" target="_blank">Comsenz Inc.</a></em>
...
<?php if($_G['setting']['statcode']) { ?><span class="pipe">| <?php echo $_G['setting']['statcode'];?></span><?php } ?><?php updatesession();?></div>

...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1364212685, '1', './data/template/1_1_common_header_forum_trade.tpl.php', './template/default', 'common/header_forum_trade')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1364212685, '1', './data/template/1_1_common_header_forum_trade.tpl.php', './template/default', 'common/header_forum_trade')
;?>

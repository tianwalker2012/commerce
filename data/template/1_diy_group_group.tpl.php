...
0
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_index.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_list.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_memberlist.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_create.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_invite.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_manage.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/group/group_right.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/footer.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seditor.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
|| checktplrefresh('./template/default/group/group.htm', './template/default/common/seditor.htm', 1363829898, 'diy', './data/template/1_diy_group_group.tpl.php', './template/default', 'group/group')
...
<dd class="cl">
<span class="y"><a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=group&amp;id=<?php echo $_G['forum']['fid'];?>&amp;handlekey=sharealbumhk_<?php echo $_G['forum']['fid'];?>" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" title="收藏" class="fa_fav">收藏</a><span class="pipe">|</span><?php if($_G['setting']['rssstatus'] && !$_GET['archiveid']) { ?><a href="forum.php?mod=rss&amp;fid=<?php echo $_G['fid'];?>&amp;auth=<?php echo $rssauth;?>" target="_blank" title="RSS" class="fa_rss">RSS</a><?php } if($status == 'isgroupuser' && helper_access::check_module('group')) { ?><span class="pipe">|</span><a href="javascript:;" onclick="showWindow('invite','misc.php?mod=invite&action=group&id=<?php echo $_G['fid'];?>')" class="fa_ivt"><strong class="xi2">邀请好友</strong></a><?php } ?></span>
...
<?php } } if($action == 'index' && $status != 2 && $status != 3) { if($status != 2) { if(helper_access::check_module('group')) { ?>
...
<td class="num">
<a class="xi2" href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>"><?php echo $thread['replies'];?></a><em><?php echo $thread['views'];?></em>
</td>
<td class="by">
<cite>
...
<div class="bm_h cl">
<h1 class="xs2">创建新<?php echo $_G['setting']['navs']['3']['navname'];?><?php if($_G['setting']['groupmod']) { ?>&nbsp;&nbsp;&nbsp;(需要审核开通)<?php } ?></h1>
</div>
<div class="bm_c">

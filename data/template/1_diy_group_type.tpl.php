...
0
|| checktplrefresh('./template/default/group/type.htm', './template/default/common/header.htm', 1363829857, 'diy', './data/template/1_diy_group_type.tpl.php', './template/default', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/default/common/footer.htm', 1363829857, 'diy', './data/template/1_diy_group_type.tpl.php', './template/default', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/default/common/header_common.htm', 1363829857, 'diy', './data/template/1_diy_group_type.tpl.php', './template/default', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/default/common/pubsearchform.htm', 1363829857, 'diy', './data/template/1_diy_group_type.tpl.php', './template/default', 'group/type')
;?>

<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); if($imagelist) { if($_GET['type'] != 'single') { ?><?php $i = 0;?><table cellspacing="2" cellpadding="2" class="imgl"><tr>
<?php } if(is_array($imagelist)) foreach($imagelist as $image) { ?><?php $i++;?><?php if($_GET['type'] != 'single') { ?>

<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('trade_view');
0
|| checktplrefresh('./template/default/forum/trade_view.htm', './template/default/common/header.htm', 1364212689, '1', './data/template/1_1_forum_trade_view.tpl.php', './template/default', 'forum/trade_view')
|| checktplrefresh('./template/default/forum/trade_view.htm', './template/default/common/footer.htm', 1364212689, '1', './data/template/1_1_forum_trade_view.tpl.php', './template/default', 'forum/trade_view')
|| checktplrefresh('./template/default/forum/trade_view.htm', './template/default/common/header_common.htm', 1364212689, '1', './data/template/1_1_forum_trade_view.tpl.php', './template/default', 'forum/trade_view')
|| checktplrefresh('./template/default/forum/trade_view.htm', './template/default/common/pubsearchform.htm', 1364212689, '1', './data/template/1_1_forum_trade_view.tpl.php', './template/default', 'forum/trade_view')
;?>
...
<div class="z"><a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em> 交易单</div>
</div>
<div id="ct" class="ct2 wp cl">
<h1 class="mt">2.交易单</h1>
<div class="mn">
<form method="post" autocomplete="off" id="tradepost" name="tradepost" action="forum.php?mod=trade&amp;orderid=<?php echo $orderid;?>">
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<div class="bm">
<h3 class="bm_h"><?php if(!$tradelog['offline']) { ?>在线交易<?php } else { ?>担保交易<?php } ?></h3>
<div class="bm_c">
<table summary="交易单" cellspacing="0" cellpadding="0" class="tfm" style="table-layout:fixed">
<tr>
<th>状态</th>
<td><?php echo $tradelog['statusview'];?> (<?php echo $tradelog['lastupdate'];?>)</td>
</tr>
<?php if($tradelog['offline'] && $offlinenext) { ?>
<tr>
<th><label for="password">登录密码</label></th>
<td><input id="password" name="password" type="password" class="px" /></td>
</tr>
<tr>
<th valign="top"><label for="message">留言</label></th>
<td>
<textarea id="buyermsg" id="message" name="message" rows="5" class="pt"></textarea>
<p class="d"><?php echo $trade_message;?> 200 字以内</p>
</td>
</tr>
<tr>
<th>&nbsp;</th>
<td class="pns"><?php if(is_array($offlinenext)) foreach($offlinenext as $nextid => $nextbutton) { ?><button class="pn" type="button" onclick="$('tradepost').offlinestatus.value = '<?php echo $nextid;?>';$('offlinesubmit').click();"><em><?php echo $nextbutton;?></em></button>&nbsp;
<?php } ?>
<input type="hidden" name="offlinestatus" value="" />
<input type="submit" id="offlinesubmit" name="offlinesubmit" style="display: none" />
</td>
</tr>
<?php } if(trade_typestatus('successtrades', $tradelog['status']) || trade_typestatus('refundsuccess', $tradelog['status'])) { ?>
<tr>
<?php if($tradelog['ratestatus'] == 3) { ?>
<th>双方已评</th><td>&nbsp;</td>
<?php } elseif(($_G['uid'] == $tradelog['buyerid'] && $tradelog['ratestatus'] == 1) || ($_G['uid'] == $tradelog['sellerid'] && $tradelog['ratestatus'] == 2)) { ?>
<th>等待对方评价</th><td>&nbsp;</td>
<?php } else { if(($_G['uid'] == $tradelog['buyerid'] && $tradelog['ratestatus'] == 2) || ($_G['uid'] == $tradelog['sellerid'] && $tradelog['ratestatus'] == 1)) { ?>
<th>对方已评</th>
<?php } else { ?>
<th>&nbsp;</th>
<?php } ?>
<td class="pns">
<?php if($_G['uid'] == $tradelog['buyerid']) { ?>
<button class="pn" type="button" onclick="window.open('home.php?mod=spacecp&ac=eccredit&op=rate&orderid=<?php echo $tradelog['orderid'];?>&type=0', '', '')"><span>评价</span></button>
<?php } elseif($_G['uid'] == $tradelog['sellerid']) { ?>
<button class="pn" type="button" onclick="window.open('home.php?mod=spacecp&ac=eccredit&op=rate&orderid=<?php echo $tradelog['orderid'];?>&type=1', '', '')"><span>评价</span></button>
<?php } ?>
</td>
<?php } ?>
</td>
</tr>
<?php } elseif(!$tradelog['offline']) { ?>
<tr>
<th>在线交易单</th>
<td class="pns">
<?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { if($tradelog['tenpayaccount']) { ?>
<button class="pn" type="button" name="" onclick="window.open('forum.php?mod=trade&orderid=<?php echo $orderid;?>&pay=yes&apitype=tenpay','','')"><span>使用财付通在线支付</span></button>
<?php } } else { if($tradelog['paytype'] == 1) { ?>
<button class="pn" type="button" onclick="window.open('<?php echo $loginurl;?>', '', '')"><span>查看并确认支付宝交易单状态</span></button>
<?php } if($tradelog['paytype'] == 2) { ?>
<button class="pn" type="button" onclick="window.open('<?php echo $loginurl;?>', '', '')"><span>查看并确认财付通交易单状态</span></button>
<?php } } ?>
</td>
</tr>
<?php } ?>
...
<div class="bm torder">
<h3 class="bm_h">交易单</h3>
<div class="bm_c">
<div class="spvimg">
<a href="forum.php?mod=viewthread&amp;do=tradeinfo&amp;tid=<?php echo $trade['tid'];?>&amp;pid=<?php echo $trade['pid'];?>"><?php if($trade['aid']) { ?><img src="<?php echo getforumimg($trade['aid']); ?>" width="90" /><?php } else { ?><img src="<?php echo IMGDIR;?>/nophotosmall.gif" /><?php } ?></a>
</div>
<div class="spi cl">
<h4 class="wx mbm bbda"><a href="forum.php?mod=viewthread&amp;do=tradeinfo&amp;tid=<?php echo $tradelog['tid'];?>&amp;pid=<?php echo $tradelog['pid'];?>" target="_blank"><?php echo $tradelog['subject'];?></a></h4>
<dl>
<dt>交易金额</dt>
<dd>
<?php if($tradelog['price'] > 0) { ?><strong><?php echo $tradelog['price'];?></strong>&nbsp;元&nbsp;&nbsp;<?php } if($_G['setting']['creditstransextra']['5'] != -1 && $tradelog['credit']) { ?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['5']]['title'];?>&nbsp;<strong><?php echo $tradelog['credit'];?></strong>&nbsp;<?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['5']]['unit'];?>&nbsp;&nbsp;<?php } if($tradelog['status'] == 0) { ?><span class="xg2">(点击下方的“更新交易单”按钮重新计算交易金额)</span><?php } ?>
</dd>
<?php if($tradelog['tradeno']) { ?>
<dt>交易单号</dt>
<dd><a href="<?php echo $loginurl;?>" class="xg2" target="_blank"><?php echo $tradelog['tradeno'];?></a></dd>
<?php } ?>

<dt>卖家</dt>
<dd>
<a href="home.php?mod=space&amp;uid=<?php echo $tradelog['sellerid'];?>" class="xg2" target="_blank"><?php echo $tradelog['seller'];?></a>
<?php if($_G['uid'] != $tradelog['sellerid']) { ?>&nbsp;<a onclick="showWindow('sendpm', this.href)" href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $tradelog['sellerid'];?>&amp;touid=<?php echo $tradelog['sellerid'];?>&amp;pmid=0&amp;daterange=2" class="xg2" target="_blank"><img src="<?php echo IMGDIR;?>/pmto.gif" title="发短消息" class="vm" /></a><?php } ?>
</dd>
<dt style="clear:left">买家</dt>
<dd>
<a href="home.php?mod=space&amp;uid=<?php echo $tradelog['buyerid'];?>" target="_blank"><?php echo $tradelog['buyer'];?></a>
<?php if($_G['uid'] != $tradelog['buyerid']) { ?>&nbsp;<a onclick="showWindow('sendpm', this.href)" href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $tradelog['buyerid'];?>&amp;touid=<?php echo $tradelog['buyerid'];?>&amp;pmid=0&amp;daterange=2" class="xg2" target="_blank"><img src="<?php echo IMGDIR;?>/pmto.gif" title="发短消息" class="vm" /></a><?php } ?>
</dd>
<?php if($tradelog['status'] == 0 && $tradelog['sellerid'] == $_G['uid']) { ?>
<dt style="clear:left"><label for="newprice">商品价格</label></dt>
<dd>
<span><input type="text" id="newprice" name="newprice" value="<?php echo $tradelog['baseprice'];?>" class="px" style="width:100px" /></span> 元&nbsp;&nbsp;
<?php if($_G['setting']['creditstransextra']['5'] != -1 && $tradelog['credit']) { ?>
<?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['5']]['title'];?> <input type="text" id="newcredit" name="newcredit" value="<?php echo $tradelog['basecredit'];?>" class="px" style="width:100px" /> <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['5']]['unit'];?>
<?php } ?>
</dd>
<?php } ?>
<dt style="clear:left"><label for="newnumber">购买数量</label></dt>
<dd><?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { ?><span><input type="text" id="newnumber" name="newnumber" value="<?php echo $tradelog['number'];?>" class="px" style="width:100px" /></span><?php } else { ?><?php echo $tradelog['number'];?><?php } ?></dd>
<dt>物流方式</dt>
<dd>
<?php if($tradelog['transport'] == 0) { ?>线下交易<?php } if($tradelog['transport'] == 1) { ?>卖家承担运费<?php } if($tradelog['transport'] == 2) { ?>买家承担运费<?php } if($tradelog['transport'] == 3) { ?>虚拟物品<?php } if($tradelog['transport'] == 4) { ?>买家收到货物后直接支付给物流公司<?php } if($tradelog['transport']) { ?>
&nbsp;运费
<?php if($tradelog['status'] == 0 && $tradelog['sellerid'] == $_G['uid']) { ?><span><input type="text" name="newfee" value="<?php echo $tradelog['transportfee'];?>" class="px" style="width:100px" /></span>&nbsp;<?php } else { ?><?php echo $tradelog['transportfee'];?>&nbsp;<?php } ?>								
元
<?php } ?>
</dd>
<?php if($tradelog['transport'] != 3) { ?>
<dt><label for="newbuyername">收货人姓名</label></dt>
<dd><?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { ?><span><input type="text" id="newbuyername" name="newbuyername" value="<?php echo $tradelog['buyername'];?>" maxlength="50" class="px" /></span><?php } else { ?><?php echo $tradelog['buyername'];?><?php } ?>&nbsp;</dd>
<dt><label for="newbuyercontact">收货地址</label></dt>
<dd><?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { ?><span><input type="text" id="newbuyercontact" name="newbuyercontact" value="<?php echo $tradelog['buyercontact'];?>" maxlength="100" size="40" class="px" /></span><?php } else { ?><?php echo $tradelog['buyercontact'];?><?php } ?>&nbsp;</dd>
<dt><label for="newbuyerzip">收货人邮编</label></dt>
<dd><?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { ?><span><input type="text" id="newbuyerzip" name="newbuyerzip" value="<?php echo $tradelog['buyerzip'];?>" maxlength="10" class="px" /></span><?php } else { ?><?php echo $tradelog['buyerzip'];?><?php } ?>&nbsp;</dd>
<dt><label for="newbuyerphone">收货人电话</label></dt>
<dd><?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { ?><span><input type="text" id="newbuyerphone" name="newbuyerphone" value="<?php echo $tradelog['buyerphone'];?>" maxlength="20" class="px" /></span><?php } else { ?><?php echo $tradelog['buyerphone'];?><?php } ?>&nbsp;</dd>
<dt><label for="newbuyermobile">收货人手机</label></dt>
<dd><?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { ?><span><input type="text" id="newbuyermobile" name="newbuyermobile" value="<?php echo $tradelog['buyermobile'];?>" maxlength="20" class="px" /></span><?php } else { ?><?php echo $tradelog['buyermobile'];?><?php } ?>&nbsp;</dd>
<?php } else { ?>
...
<?php } ?>
<dt valign="top"><label for="newbuyermsg">备注信息</label></dt>
<dd><?php if($tradelog['status'] == 0 && $tradelog['buyerid'] == $_G['uid']) { ?><span><textarea id="newbuyermsg" name="newbuyermsg" rows="5" class="pt"><?php echo $tradelog['buyermsg'];?></textarea></span><?php } else { ?><?php echo $tradelog['buyermsg'];?><?php } ?></dd>
<?php if($tradelog['status'] == 0) { ?>
<dt>&nbsp;</dt>
<dd class="pns">
<button class="pn" type="submit" name="tradesubmit" value="true"><span>更新交易单</span></button>
</dd>
<?php } ?>
</dl>
</div>
...
<h3 class="bbda pbm mtw">留言</h3>
<div class="xld xlda"><?php if(is_array($messagelist)) foreach($messagelist as $message) { ?><dl class="bbda cl">
<dd class="m avt"><?php echo avatar($message[0],small);?></dd>
<dt><a href="home.php?mod=space&amp;uid=<?php echo $message['0'];?>" target="_blank"><?php echo $message['1'];?></a>&nbsp;<span class="xg1 xw0" <?php echo $message['2'];?></span></dt>
<dd><?php echo $message['3'];?></dd>
</dl>
<?php } ?>
</div>
<?php } ?>
...
<?php if($usertrades) { ?>
<div class="bm">
<h3 class="bm_h"><?php echo $trade['seller'];?> 推荐的商品</h3>
<div class="bm_c">
<ul class="ml tradl cl"><?php if(is_array($usertrades)) foreach($usertrades as $usertrade) { ?><li>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $usertrade['tid'];?>&amp;do=tradeinfo&amp;pid=<?php echo $usertrade['pid'];?>" class="tn">
<?php if($usertrade['displayorder'] > 0) { ?><em class="hot">推荐商品</em><?php } if($usertrade['aid']) { ?><img src="<?php echo getforumimg($usertrade['aid']); ?>" width="130" alt="<?php echo $usertrade['subject'];?>" /><?php } else { ?><img src="<?php echo IMGDIR;?>/nophoto.gif" width="130" alt="<?php echo $usertrade['subject'];?>" /><?php } ?>
</a>
...
<?php } ?>
<h4><a href="forum.php?mod=viewthread&amp;tid=<?php echo $usertrade['tid'];?>&amp;do=tradeinfo&amp;pid=<?php echo $usertrade['pid'];?>"><?php echo $usertrade['subject'];?></a></h4>
</li>
<?php } ?>
</ul>
</div>
